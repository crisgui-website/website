...
export function Info() {
  return (
    <div className="max-w-screen-xl m-auto mb-8 sm:mb-0 mt-14 sm:mt-36 px-4 sm:px-0">
      <div className="flex flex-col sm:flex-row w-full sm:gap-16">
        <div className="flex flex-col sm:w-2/4">
          ...
          <h1 className="mb-10 sm:mb-24 mt-6 is-h3 text-gray-900 font-normal">
            Inovação que Impulsiona Suas Operações
          </h1>
        </div>

        <div className="flex flex-col sm:w-2/4 gap-[72px]">
          <div>
